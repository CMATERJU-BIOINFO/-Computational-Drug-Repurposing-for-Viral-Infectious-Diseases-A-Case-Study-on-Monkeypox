...
path_set='C:\\Users\\Sovan Saha\\Desktop\\Desktop 14-09-2023\\Dekstop Activities 5\\monkeypox\\Drug analysis\\'

f1=open(path_set+'DrugBank.txt','r')
drug_detail=f1.readlines()

f2=open(path_set+'SpreadersN.txt','r')
...
#print(sorted_dict)
with open("Spreader_drug_frequency1.txt", 'a') as f: 
